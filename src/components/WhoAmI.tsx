...
import SplashCursor from './SplashCursor'; // Importamos el SplashCursor
...
const WhoAmI: React.FC = () => {
  return (
    <section
      id="about"
      className="relative min-h-screen bg-black text-white pt-32 pb-24 md:pt-40 md:pb-32 overflow-hidden flex items-center"
    >
      {/* --- CINTA INFINITA ESTILIZADA (MARQUEE) --- */}
      <div className="absolute top-0 left-0 w-full h-16 bg-black/60 backdrop-blur-2xl border-y border-white/5 shadow-[0_20px_40px_rgba(0,0,0,0.8)] overflow-hidden flex items-center z-30 pointer-events-none">
        {/* Líneas de luz brillante arriba y abajo */}
        ...
        >
          ...
          <span className="flex items-center text-gray-500">
             ...
             <span className="mx-6 px-4 py-1.5 rounded-full border border-orange-500/40 text-orange-400 bg-orange-500/10 shadow-[0_0_15px_rgba(249,115,22,0.2)]">
               CREATIVE DEVELOPER
             </span>
             ✦ REACT ✦ TYPESCRIPT ✦ NODE.JS ✦ TAILWIND ✦
             <span className="mx-6 px-4 py-1.5 rounded-full border border-blue-500/40 text-blue-400 bg-blue-500/10 shadow-[0_0_15px_rgba(59,130,246,0.2)]">
               PROBLEM SOLVER
             </span>
          </span>
          {/* SEGUNDO BLOQUE (Clon exacto para el loop infinito) */}
          <span className="flex items-center text-gray-500">
             ✦ FULL STACK ✦ FRONTEND ✦ BACKEND ✦ UI/UX DESIGN ✦ WEBGL ✦
             <span className="mx-6 px-4 py-1.5 rounded-full border border-orange-500/40 text-orange-400 bg-orange-500/10 shadow-[0_0_15px_rgba(249,115,22,0.2)]">
               CREATIVE DEVELOPER
      ...
      {/* --- FONDOS Y LUCES ANIMADAS (Z-0) --- */}
      <motion.div 
        animate={{ scale: [1, 1.2, 1], opacity: [0.4, 0.6, 0.4] }}
        transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }}
        className="absolute top-[5%] -left-[10%] w-[400px] h-[400px] md:w-[600px] md:h-[600px] bg-blue-600/30 rounded-full mix-blend-screen filter blur-[130px] pointer-events-none z-0"
      />
      <motion.div 
        animate={{ scale: [1, 1.3, 1], opacity: [0.3, 0.5, 0.3] }}
        transition={{ duration: 10, repeat: Infinity, ease: "easeInOut", delay: 1 }}
        className="absolute bottom-[5%] -right-[10%] w-[500px] h-[500px] md:w-[700px] md:h-[700px] bg-orange-600/20 rounded-full mix-blend-screen filter blur-[140px] pointer-events-none z-0"
      />
      <motion.div 
        animate={{ opacity: [0.2, 0.4, 0.2] }}
        transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 3 }}
        className="absolute -bottom-[20%] left-[30%] w-[600px] h-[400px] bg-purple-700/20 rounded-full mix-blend-screen filter blur-[120px] pointer-events-none z-0"
      />

      {/* --- FLUIDO INTERACTIVO DE FONDO (Z-10) --- */}
      ...
      {/* --- CONTENIDO PRINCIPAL (Z-20 para estar encima del líquido) --- */}
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="px-5 py-3 rounded-xl bg-black/40 border border-white/10 backdrop-blur-md hover:bg-white/10 transition-colors"
                >
